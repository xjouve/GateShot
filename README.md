...
- **Supplementary playback stabilizer** — image-based smoothing toggle for residual shake on imported clips (building blocks already in `:processing:stabilize`)
- **Automatic color correction** — snow-scene analysis + tone curves applied at playback
